  ...
  return (
    <section className="section container">
      <div className="Releted">
        <div className="Releted__header">
          <h3 className="Releted__header-title">Releted Products</h3>
        </div>
        <ul className="Releted__list">
          <li className="product Releted__product">
            <div className="product__image Releted__product-image">
              <img src={image1} alt="" />
            ...
            <div className="product__description">
              <span className="product__title">Barberton Daisy</span>
              <span className="product__price">$119.00</span>
            </div>
          </li>
        ...
        <div className="Releted__dots">
          <svg
            className="Releted__dot"
            width="12.000000"
            height="12.000000"
            viewBox="0 0 12 12"
            fill="none"
